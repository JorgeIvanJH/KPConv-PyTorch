...
# ----------------------------------------------------------------------------------------------------------------------
#
#      Callable script to start a training on MiniMarket dataset
#
# ----------------------------------------------------------------------------------------------------------------------
#
#      Hugues THOMAS - 06/03/2020 (original)
#      Jorge Jaramillo - 2024 (adapted for MiniMarket)
...
if __name__ == '__main__':
    ...
    test_sampler = MiniMarketSampler(test_dataset)
